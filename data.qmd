...
graph TD
    ...
    G --> I[Trend Analysis<br/>Linear Regression]
...
**Method:** For each block group, calculate the linear regression slope of VIIRS brightness values over the 2022-2024 observation period

**Tool:** scipy.stats.linregress

**Output:** `brightness_trend` (slope) for each of 1,283 block groups

**Classification:**

| Category | Slope Threshold | Count | % |
|----------|-----------------|-------|---|
...
<span class="stat-label">of Philadelphia Showing Darkening Trend</span>
<p style="margin-top: 1rem; color: var(--text-muted);">399 block groups experiencing declining brightness (2022-2024)</p>
</div>

<div class="callout callout-danger">
<div class="callout-title">Key Finding</div>
**399 Philadelphia block groups (31.1%) show declining lighting levels.** The 112 "Darkening Fast" areas represent highest priority for intervention.
</div>
...
- **Trend analysis:** Describes observed patterns, not predictions
...
5. **Trend Analysis** (Python scipy.stats)
   - Calculate brightness slopes via linear regression
   - Classify areas by trend category
   - Identify 399 darkening areas
